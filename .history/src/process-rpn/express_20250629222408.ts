    ...
    if (operatorStack.length === 0) {
      ...
      if (
        this.comparePriority(
          { value: typeof curOperator.value === 'string' ? curOperator.value : String(curOperator.value) },
          { value: typeof last.value === 'string' ? last.value : String(last.value) }
        ) === 1
      ) {
        this.addOperator(curOperator, operatorStack)
      } else {
        ...
        while (operatorStack.length > 0) {
          ...
          if (
            this.comparePriority(
              { value: typeof curOperator.value === 'string' ? curOperator.value : String(curOperator.value) },
              { value: typeof top.value === 'string' ? top.value : String(top.value) }
            ) < 1 &&
